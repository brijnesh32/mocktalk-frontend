...
const ReportCard = () => {
  ...
  const handleSaveReport = async () => {
    ...
    try {
      setSaving(true);
      const reportToSend = { ...report, email };
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/save-report/`, reportToSend);
  ...
  return (
    /* main-content handles margin-left (sidebar) + margin-top (navbar) */
    <div className={`main-content ${isCompact ? "compact" : ""}`}>

      {/* centred, max-width container for the card */}
